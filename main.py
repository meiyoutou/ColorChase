...
def _user_asset_roots():
    return {
        ...
        "references": USER_REFS_DIR,
        "profiles": USER_PROFILES_DIR,
    }
...
@app.post("/api/prepare_lr_preset")
